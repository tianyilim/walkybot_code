...
leftServos._pca.reset()
rightServos._pca.reset()
print("software reset!")

# leg_r1 = hex_legs.hexLeg(kit=leftServos, legNum=1, leftright='right')
# leg_r1.write_angles((90,90,90))

leg_r1 = hexapod.hex_leg(leg_end, DEFAULT_Z, leg_nums=(15,14,13), servoKit=rightServos, leg_name="leg_r1", offsets=(0,0,0))
